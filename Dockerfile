...
echo "source /opt/ros/$ROS_DISTRO/setup.bash; source /colcon_ws/install/setup.bash || true; echo UID: $UID; echo ROS_DOMAIN_ID: $ROS_DOMAIN_ID; $LAUNCH_COMMAND" >> /run.sh && chmod +x /run.sh
